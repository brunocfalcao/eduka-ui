...
<style type="text/css" rel="stylesheet" media="all">
    ...
    *:not(br):not(tr):not(html) {
    ...
    .button--green {
        ...
        border-right: 18px solid {{ $secondaryColor }};
        border-bottom: 10px solid {{ $secondaryColor }};
        border-left: 18px solid {{ $secondaryColor }};
    }

    .button--red {
        background-color: {{ $dangerColor }};
        border-top: 10px solid {{ $dangerColor }};
        border-right: 18px solid {{ $dangerColor }};
        border-bottom: 10px solid {{ $dangerColor }};
        border-left: 18px solid {{ $dangerColor }};
    }
